...
# Utils
from sharepoint.utils.move_files import move_file_to_destination


class MoveFilesSharepointView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        status_code, message = move_file_to_destination(source_file_url, destination_folder_url)
